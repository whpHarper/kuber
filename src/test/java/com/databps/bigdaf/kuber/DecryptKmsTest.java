 ...
 */
public class DecryptKmsTest {

  private String filename="/path/test2/jmx.pwd";
  private String dest="/Users/merlin/Documents/";
  ...
  public void testOne() throws Exception {
    ...
    int returnCode = ToolRunner.run(new DecryptKms(), args);
